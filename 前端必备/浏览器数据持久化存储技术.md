...
![image-20200710180444716](https://raw.githubusercontent.com/ahaMOMO/autumn-stroke/master/img/20200710180446.png)
...
次访问该网页，查看请求与响应信息可以看到请求头部没有任何关于http缓存相关的信息。而返回的HTTPresponse包含了以下头部信息。
